...
- **Production ID**: The short script reference shown for a line, such as `I-12` or `3.2-15`. Directors and actors can use this value to discuss the exact line. Cuemaster shows production IDs instead of ordinal labels like "Line 12".
- **Cue**: The audio and text that prompts your next line. It may be another role, narration, or a heading.
- **Speak-along practice**: A practice option that plays the cue, waits for the speak-along pause, then plays your reference line so you can speak with it.
...
- The compact buttons beside **Your Line** provide quick access to speak-along practice, tempo timing, and Show lines.
...
- **Keep timing targets in sync** changes both timing values together, which is usually what you want while rehearsing.
...
- **Last 2s** plays only the end of the immediate cue.
