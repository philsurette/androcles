...
import type { RoleRecordingPackManifest } from "./recordingPackageManifest";
...
const manifestSchema = z.object({
  ...
  package_type: z.literal("role_recording_pack"),
  play: z.object({
    id: z.string().min(1),
...
export function validateRecordingPackManifest(value: unknown): RecordingPack {
  const manifest = manifestSchema.parse(value) satisfies RoleRecordingPackManifest;
  return {
